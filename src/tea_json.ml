module Decoder = struct
    ...
    Decoder
      (fun value ->
        ...
        | JSONString s ->
            Tea_result.Ok s
        | _ ->
            Tea_result.Error "Non-string value" )
  ...
  let int =
    Decoder
      (fun value ->
        ...
        | _ ->
            Tea_result.Error "Non-int value" )
    ...
    Decoder
      (fun value ->
        ...
        | JSONNumber n ->
            Tea_result.Ok n
        | _ ->
            Tea_result.Error "Non-float-value" )
    ...
    Decoder
      (fun value ->
        ...
        | JSONFalse ->
            Tea_result.Ok false
        | _ ->
            Tea_result.Error "Non-boolean value" )
    ...
    Decoder
      (fun value ->
        ...
        | JSONNull ->
            Tea_result.Ok v
        | _ ->
            Tea_result.Error "Non-null value" )
  ...
  let list (Decoder decoder) =
    Decoder
      (fun value ->
        ...
        | _ ->
            Tea_result.Error "Non-list value" )
  ...
  let array (Decoder decoder) =
    Decoder
      (fun value ->
        ...
        | _ ->
            Tea_result.Error "Non-array value" )
      ...
      (fun value ->
        ...
        | JSONObject o -> (
            ...
            let parse k l =
              ...
              | None ->
                  raise (ParseFail ("Key is undefined: " ^ k))
              | Some v -> (
                match decoder v with
                | Tea_result.Ok r ->
                    (k, r) :: l
        ...
        | _ ->
            Tea_result.Error "Non-keyValuePair value" )
  ...
  let dict (Decoder decoder) =
    Decoder
      (fun value ->
        ...
        | _ ->
            Tea_result.Error "Non-dict value" )
    ...
    Decoder
      (fun value ->
        ...
        | JSONObject o -> (
          ...
          | None ->
              Tea_result.Error ("Field Value is undefined: " ^ key)
          | Some v -> (
            match decoder v with
            | Ok _ as o ->
                o
            | Error e ->
                Error ("field `" ^ key ^ "` -> " ^ e) ) )
        | _ ->
            Tea_result.Error "Non-fieldable value" )
  ...
  let map7 mapper (Decoder decoder1) (Decoder decoder2) (Decoder decoder3)
      (Decoder decoder4) (Decoder decoder5) (Decoder decoder6) (Decoder decoder7)
      =
    Decoder
      (fun value ->
        let open Tea_result in
  ...
  let decodeValue (Decoder decoder) value =
    ...
    | ParseFail e ->
        Tea_result.Error e
    | _ ->
        Tea_result.Error "Unknown JSON parsing error"
